...
#' @param ... further arguments to pass to the file-writing function: \code{\link{saveRDS}}, \code{\link[data.table]{fwrite}}, or \code{\link[ggplot2]{ggsave}}.
...
save_list <-
  function(x, dir, ext = c(".rds", ".csv", ".pdf"), names = NULL,
           cores = 1, ...){
